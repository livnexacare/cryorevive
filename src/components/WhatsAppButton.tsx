...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-4 md:bottom-6 md:right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-3.5 md:p-4 shadow-lg flex items-center gap-2 transition-all duration-200 hover:scale-110"
